...
| 7.4 ✅ | `src/types.rs` (regex_cache, regex_pattern_from_bytes), `runner/mod.rs` (`~`, `!~`, RS-regex, paragraph), `runner/builtins.rs` (match/split/sub/gsub), `src/parser.rs` (decode_string_escapes → Vec<u8>) | `// PHASE7.2→7.4 BRIDGE` rimossi (10/10, 2026-05-23) |
